...
const storyParagraphs = [
  ...
  "Για περισσότερα από 30 χρόνια πλέον, με καθημερινή παρουσία, επιμονή στην ποιότητα και φροντίδα στην εξυπηρέτηση, κατάφερε να κερδίσει την εμπιστοσύνη ανθρώπων που επέστρεφαν ξανά και ξανά, όχι μόνο για τη γεύση, αλλά και για τον τρόπο που ένιωθαν.",
  ...
  "Το The VeatERAN Van γεννήθηκε μέσα από αυτή τη διαδρομή. Είναι ένας τρόπος να ταξιδέψει η ίδια φροντίδα έξω από το ψητοπωλείο, σε γάμους, βαπτίσεις, ιδιωτικές και εταιρικές εκδηλώσεις, πάντα με την ίδια λογική: καλό φαγητό, ευγενικό service και σεβασμό στους ανθρώπους που μας εμπιστεύονται.",
];
