    ...
    <section id="story" className="bg-[#fffaf0] px-5 py-20 sm:px-8">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="space-y-5 text-base leading-7 text-[#3d3a32]">
          ...
          <p>
            Με βάση την Αθήνα — διαθέσιμο για εκδηλώσεις σε όλη την Ελλάδα, το
            van στήνεται ως ένα όμορφο σημείο συνάντησης με rustic υλικά, soft
            gold λεπτομέρειες και μεσογειακή απλότητα.
          </p>
        </div>
      </div>
    </section>
