...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[#0A5458] pt-28 text-white">
      ...
      <div className="mx-auto grid min-h-[660px] max-w-7xl items-center gap-10 px-5 pb-16 sm:px-8 lg:grid-cols-[1.02fr_0.98fr]">
        ...
        <div className="relative min-h-[430px]">
          <div className="absolute inset-0 rounded-3xl border border-white/15 bg-[linear-gradient(145deg,rgba(248,242,229,0.96),rgba(217,183,111,0.34)),radial-gradient(circle_at_70%_20%,rgba(255,255,255,0.82),transparent_24%)] p-4 shadow-2xl shadow-black/25">
